...
#pragma omp parallel for default(none) \
	shared(pix,radius,gal,tau,off,y2,m,band,age,ipi,imax,jmax,ctr) \
	private(i,j,k,r,theta,L,arg,n)
		for (i=0;i<imax;i++)
		{
			for (j=0;j<jmax;j++)
			{
...
#pragma omp parallel for default(none) \
	shared(pix,radius,sn,ipi,coef,tau,off,imax,jmax,ctr,tauprime,mass1,mass2,dth) \
	private(i,j,k,r,theta,L,arg,n,arg1,arg2,m1,m2)
	for (i=0;i<imax;i++)
	{
		for (j=0;j<jmax;j++)
		{	
...
#pragma omp parallel for default(none) \
	shared(flag,n,fr,pix) \
	private(i,tempr,tempt,tempv,temps) 
